...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "tongbaocoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"112.124.48.189", "112.124.48.189"},
    {"49.213.15.199", "49.213.15.199"},
    {"103.233.250.98", "103.233.250.98"}
};

static const char *strTestNetDNSSeed[][2] = {
    {"tongbaocointools.com", "testnet-seed.tongbaocointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. tongbaocoin is probably already running."), addrBind.ToString().c_str());
        else
